...
(function tag2(){
	...
	var ua = x.e(navigator.userAgent);
	var visid = x.v("visid");
	var name = x.e(x.n("name","//training.ensighten.com/js/tag2"));

	var requestURL = protocol + "//" + host + "/" + filename + "?tag=2&name=" + name + "&cb=" + cb + "&visid=" + visid + "&url=" + url + "&ua=" + ua;
